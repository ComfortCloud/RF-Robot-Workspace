package com.example.readercontrol;
...
public class ReaderHandler implements LLRPEndpoint {

    private LLRPConnection connection;

    public static Logger logger  = Logger.getLogger("Reader Handler" );
        ...
        try {
            ...
            if (status.equals(new StatusCode("M_Success"))) {
                ...
                if ((dev_cap == null) ||
                    ...
                    logger.error("com.example.readercontrol.Main must use Impinj model Reader, not " +
    ...
    private ADD_ROSPEC buildROSpecFromFile() {
        ...
        try {
            LLRPMessage addRospec = Util.loadXMLLLRPMessage(new File("./src/com/example/readercontrol/ADD_ROSPEC.xml"));
    ...
    public void setReaderConfiguration() {
        ...
        try {
            LLRPMessage setConfigMsg = Util.loadXMLLLRPMessage(
                    new File("./src/com/example/readercontrol/SET_READER_CONFIG.xml"));
